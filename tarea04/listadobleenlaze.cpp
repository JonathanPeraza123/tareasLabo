...
int main()
{
    ...
    ll.addFront(1, "Jonathan Peraza", "administrador");
    ll.addFront(2, "Mario bautista", "administrador");
    ll.addFront(3, "Ana Marcela", "administrador");
    ll.addFront(4, "Andrea Rosario", "cliente");
    ll.addFront(5, "Alberto Judaz", "cliente");
    ll.addFront(6, "Juan Guarnizo", "trabajador");
    ll.addFront(7, "Elizabeth Villanueva", "trabajador");
    ll.addFront(8, "Nicole Martinez", "trabajador");

    //  Anadir al final
    ll.addBack(9, "Fernando Sandoval" , "administrador");
    ll.addBack(10, "Juana Miguelena", "administrador");
    ll.addBack(11, "Sor Antonila Ceron", "cliente");
    ll.addBack(12, "Javier Parades", "cliente");
    ll.addBack(13, "Miguel Bukele", "trabajador");
    ll.addBack(14, "Lisbeth Salinas", "trabajador");
